...
alias tobash="sudo chsh $USER -s /bin/bash && echo 'Logout for change to take effect.'"
alias tozsh="sudo chsh $USER -s /bin/zsh && echo 'Logout for change to take effect.'"
...
alias mymirror="sudo reflector --verbose -c DE -c NL -c GB --protocol https --age 8 --sort rate --number 10 --save /etc/pacman.d/mirrorlist"
...
alias ytvdl="youtube-dl -f bestvideo+bestaudio --merge-output-format mkv "

#Recent Installed Packages
alias rip="expac --timefmt='%Y-%m-%d %T' '%l\t%n %v' | sort | tail -200 | nl"
alias riplong="expac --timefmt='%Y-%m-%d %T' '%l\t%n %v' | sort | tail -3000 | nl"

#iso and version used to install AsterLinux
...
alias bls="betterlockscreen -u /usr/share/backgrounds/asterlinux/"
